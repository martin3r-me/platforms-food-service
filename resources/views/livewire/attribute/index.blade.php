<div>
    <div class="d-flex justify-between items-center mb-4">
        ...
        <x-ui-button variant="primary" wire:click="openCreateModal">New Attribute</x-ui-button>
    </div>
    ...
    @else
        <div class="text-center py-8 text-sm text-muted">No attributes yet</div>
    @endif

    <x-ui-modal wire:model="modalShow" size="md">
        <x-slot name="header">Create Attribute</x-slot>
