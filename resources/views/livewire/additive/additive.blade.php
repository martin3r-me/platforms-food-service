    ...
    <div class="flex-grow-1 d-flex flex-col">
        <div class="border-top-1 border-bottom-1 border-muted border-top-solid border-bottom-solid p-2 flex-shrink-0">
            <div class="d-flex gap-1">
                <div class="d-flex">
                    <a href="{{ route('food-service.additives.index') }}" class="d-flex px-3 border-right-solid border-right-1 border-right-muted underline" wire:navigate>
                        Additives
                    </a>
                </div>
        ...
        <div class="flex-grow-1 overflow-y-auto p-4">
            <div class="mb-4 p-3 bg-muted-5 rounded-lg">
                ...
                <div class="space-y-1 text-sm">
                    <div><strong>Name:</strong> {{ $additive->name }}</div>
